...
def _data_source() -> str:
    # The persisted SQLite ledger is authoritative for locally supplied bookings.
    # An iCal URL is an import/sync source, not a separate ledger.
    return "sqlite-ledger" if (os.getenv("TIMEOE_AIRBNB_DB") or os.getenv("AIRBNB_DB_PATH")) else "sqlite-ledger"
